  ...
  let datagroups = graphGroup.selectAll(".datagroup").data(data).enter()
    .append("g")
      ...
      .on("mouseover", function(event, d){
        ...
        // option one: 
        // go to wherever the hovered element is using the
        // same maths of the translation of it above:
        // OPTION #1
        ...
        //   .attr("opacity", 1)
        // ;
        // else. we can get the location of out mouse
        ...
        // reference: https://github.com/d3/d3-selection#pointer
        ...
        datagroups.filter(function(datapoint){
          // we loop over al elements 
          // if one of them is the same as we hoverd...
          if(datapoint == d){
            // ...then we return false to filter it out
            return false;
          }else{
            // ...otherwise we return true to "let it through"
            return true;
          }
        }).select("circle") // at this point we only deal we elements we let through, ie not the element we hovered
          .transition()
          // .delay(function(d, i){
          //   return i;
          // })
      ...
      .on("mouseout", function(event, d){
        textElement.text("Historic Events")
          .attr("opacity", 0)
        ;
